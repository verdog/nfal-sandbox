...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("main",39,38,56,48),::ApplicationMain_obj::create_dyn());
...
HXLINE(  36)		app->meta->set(HX_("company",3d,15,69,83),HX_("Josh Chandler",0d,5e,06,4a));
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("main",39,38,56,48));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("NFA-l sandbox",0f,51,ef,f3));
HXLINE(  39)		app->meta->set(HX_("packageName",f1,04,ad,04),HX_("",00,00,00,00));
...
HXLINE(  46)		 ::Dynamic attributes =  ::Dynamic(::hx::Anon_obj::Create(16)
            			...
            			->setFixed(9,HX_("title",98,15,3b,10),HX_("NFA-l sandbox",0f,51,ef,f3))
...
HXLINE(  66)		attributes->__SetField(HX_("context",ef,95,77,19), ::Dynamic(::hx::Anon_obj::Create(8)
            			...
            			->setFixed(3,HX_("background",ee,93,1d,26),4473941)
